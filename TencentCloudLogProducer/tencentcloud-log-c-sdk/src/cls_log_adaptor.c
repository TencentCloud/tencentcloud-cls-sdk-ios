#include "cls_log_adaptor.h"
#include <string.h>
#include <time.h>

CLS_LOG_CPP_START

__attribute__((visibility("default"))) void SetClsPostFunc(int (*f)(const char *url,
                                                                            char **header_array,
                                                                            int header_count,
                                                                            const void *data,
                                                                            int data_len));

__attribute__((visibility("default"))) void ClsSetTimeUnixFunc(unsigned int (*f)());
