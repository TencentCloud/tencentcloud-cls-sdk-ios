...
+ (CLSNetWorkScheme *)createDefault {
    ...
    date = [NSDate dateWithTimeIntervalSince1970:[[NSString stringWithFormat:@"%ld%@%@", (long)[ClsTimeUtils getClsTimeInMilliis], @".",[scheme.local_timestamp substringFromIndex:10]] doubleValue]];
