...
- (void)run {
    ...
    if (addr.sin_addr.s_addr == INADDR_NONE) {
        ...
        if (host == NULL || host->h_addr == NULL) {
            ...
            if (_complete != nil) {
                ...
                [_sender clsReport:@"Problem accessing the DNS" method:@"traceRoute" domain:_host customFiled:_traceRouteExt];
            }
            return;
        }
    ...
    if (-1 == fcntl(recv_sock, F_SETFL, O_NONBLOCK)) {
        ...
        if (_complete != nil) {
            ...
            [_sender clsReport:@"fcntl socket error!" method:@"traceRoute" domain:_host customFiled:_traceRouteExt];
        }
        close(recv_sock);
        return;
    }
    ...
    [_sender clsReport:[self buildResult]method:@"traceRoute" domain:_host customFiled:_traceRouteExt];
}
