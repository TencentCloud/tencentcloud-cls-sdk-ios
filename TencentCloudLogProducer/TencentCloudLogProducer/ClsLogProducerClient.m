...
@interface ClsLogProducerClient ()
@end

@implementation ClsLogProducerClient
...
@implementation ClsLogSearchClient
-(SearchClsReult) SearchLog:(NSString*)region secretid:(NSString*) secretid
